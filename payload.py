...
def main():
    ...
    while True:
        try:
            ...
            if debug:
                print(err)
            sleep_for = randint(3, 7)  # entropy
            if debug:
                print('Reconnecting in %d seconds ... ' % sleep_for)
            sleep(sleep_for)  # reconnect on failure
